...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('assets/home/img/contact-bg.jpg')">
        ...
        <!-- To use the contact form, your site must be on a live web host with PHP! The form will not work locally! -->
          <ul class="list-inline text-center">
            <li class="list-inline-item">
              <a href="mailto:2017470020@ftumj.ac.id">
            ...
            <li class="list-inline-item">
              <a href="https://twitter.com/bkhrihsn">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://www.linkedin.com/in/bukharihasan">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://github.com/bukharihasan">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
