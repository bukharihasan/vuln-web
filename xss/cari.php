...
include '../koneksi.php';
$cari = $_GET['cari'];
$result = mysqli_query($conn, "SELECT * FROM posting WHERE judul LIKE '%{$cari}%' OR konten LIKE '%{$cari}%'");
?>
...
<body>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            ...
            <span class="subheading">Hasil pencarian dari <?=$cari?></span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <b>Menampilkan <?= mysqli_num_rows($result);?> Hasil.</b>
        <?php while ( $row = mysqli_fetch_assoc($result) ) : ?>
          <div class="post-preview">
            ...
            <p class="post-meta">Posted by Admin on <?= $row["tanggal"];?></p>
        </div>
        <?php endwhile; ?>
      </div>
    </div>
